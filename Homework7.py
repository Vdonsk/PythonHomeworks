...
# def pam(text: str) -> str:
#     return 'Парам пам-пам' if len(set(sum(map(lambda x: x in 'а,е,ё,и,о,у,ы,э,ю,я', phrase))for phrase in text.lower().split())) == 1 else 'Пам парам'

# print(f'Вывод: {pam(rhythm)}')
...
# print(f'Ввод: print_operation_table(lambda x, y: x * y)')
